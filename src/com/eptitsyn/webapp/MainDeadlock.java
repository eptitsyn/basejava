...
public class MainDeadlock {
    ...
    public static class SomeThread implements Runnable {
        ...
        public void run() {
            ...
            synchronized (lock1) {
                System.out.println(
                    "Thread " + Thread.currentThread().getName() + " locked object " + lock1);
                try {
                ...
                System.out.println(
                    "Thread " + Thread.currentThread().getName() + " trying to lock " + lock2);
                synchronized (lock2) {
                    System.out.println(
                        "Thread " + Thread.currentThread().getName() + " locked object " + lock2);
